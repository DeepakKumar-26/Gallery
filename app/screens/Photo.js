...
function Photo({...props}) {
  ...
  return (
    <View
      ...
      <Image
        source={{
          uri: props.route.params.item.urls.small,
        }}
        style={styles.image}
      />
          ...
          {viewDetails && (
            <View
              ...
              <Text style={styles.text}>
                Owner: {props.route.params.item.user.name}
              </Text>
              <Text style={styles.text}>
                User Id: {props.route.params.item.user.id}
              </Text>
              <Text style={styles.text}>
                Image Id : {props.route.params.item.id}
              </Text>
            </View>
          )}
